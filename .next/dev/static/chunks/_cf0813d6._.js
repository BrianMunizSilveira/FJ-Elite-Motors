...
_s(AnimatedBackground, "pLgJpozskY8nTOv7EjRk4tB3HJc=");
...
"[project]/src/components/VehicleGallery.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
function VehicleGallery({ images, model }) {
    _s();
    ...
    const nextImage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "VehicleGallery.useCallback[nextImage]": ()=>{
            setCurrentImageIndex({
                "VehicleGallery.useCallback[nextImage]": (prev)=>(prev + 1) % displayImages.length
            }["VehicleGallery.useCallback[nextImage]"]);
        }
    }["VehicleGallery.useCallback[nextImage]"], [
    ...
    const prevImage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "VehicleGallery.useCallback[prevImage]": ()=>{
            setCurrentImageIndex({
                "VehicleGallery.useCallback[prevImage]": (prev)=>(prev - 1 + displayImages.length) % displayImages.length
            }["VehicleGallery.useCallback[prevImage]"]);
        }
    }["VehicleGallery.useCallback[prevImage]"], [
        displayImages.length
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "VehicleGallery.useEffect": ()=>{
            const handleKeyDown = {
                "VehicleGallery.useEffect.handleKeyDown": (e)=>{
                    if (!isLightboxOpen) return;
                    if (e.key === "ArrowLeft") prevImage();
                    if (e.key === "ArrowRight") nextImage();
                    if (e.key === "Escape") setIsLightboxOpen(false);
                }
            }["VehicleGallery.useEffect.handleKeyDown"];
            window.addEventListener("keydown", handleKeyDown);
            return ({
                "VehicleGallery.useEffect": ()=>window.removeEventListener("keydown", handleKeyDown)
            })["VehicleGallery.useEffect"];
        }
    }["VehicleGallery.useEffect"], [
        isLightboxOpen,
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "relative group rounded-xl overflow-hidden shadow-2xl border border-gray-800 aspect-video bg-gray-900",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                        ...
                        fileName: "[project]/src/components/VehicleGallery.tsx",
                        lineNumber: 53,
                        columnNumber: 9
                    }, this),
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "absolute inset-0 bg-black/20 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-between px-4",
                        children: [
            ...
            displayImages.length > 1 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "grid grid-cols-5 gap-2 md:gap-4 overflow-x-auto pb-2",
                children: displayImages.map((img, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        onClick: ()=>setCurrentImageIndex(index),
                        className: `relative rounded-lg overflow-hidden border aspect-video transition-all ${currentImageIndex === index ? "border-gold ring-2 ring-gold/50 scale-105" : "border-gray-800 opacity-60 hover:opacity-100"}`,
            ...
            isLightboxOpen && typeof document !== 'undefined' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2d$dom$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createPortal"])(/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "w-full h-full max-w-7xl flex items-center justify-center relative",
                        onClick: ()=>setIsLightboxOpen(false),
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                                src: displayImages[currentImageIndex].url,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "absolute bottom-4 left-1/2 transform -translate-x-1/2 text-white/90 bg-black/60 px-6 py-2 rounded-full text-sm font-bold font-mono border border-gray-700 backdrop-blur-sm",
                                children: [
                                    currentImageIndex + 1,
                                    " / ",
                                    displayImages.length
...
_s(VehicleGallery, "jRmedAQeZ4EyoGQ948MHDtOiMW0=");
_c = VehicleGallery;
var _c;
__turbopack_context__.k.register(_c, "VehicleGallery");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_cf0813d6._.js.map